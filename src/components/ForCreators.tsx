...
const ForCreators: React.FC = () => {
  ...
  return <section id="for-creators" className="py-20 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          <div className="lg:w-1/2">
            ...
            <div className="space-y-6">
              {features.map(feature => <div key={feature.id} className="flex items-start">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative p-2 bg-gradient-to-r from-brand-primary/30 to-brand-secondary/30 rounded-2xl shadow-xl">
              ...
              <div className="relative rounded-xl overflow-hidden border border-white/20">
                <img alt="Palestrante jovem apresentando" className="w-full object-cover rounded-xl" loading="lazy" src="/lovable-uploads/0f5b20aa-6d06-42c5-81aa-62f127140293.jpg" />
              </div>
